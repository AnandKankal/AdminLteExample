 ...
 %></font>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a href="addUser"><button class="btn btn-block btn-primary btn-sm pull-right" style="width:100px;">Add User</button></a>
                  <div class="box-tools">
                  </div>
                </div><!-- /.box-header -->
	...
	%>
                    ...
                    <tr>
                      ...
                      <td><% out.println(i);%></td>
                      <td><% out.println(name.getName());%></td>
                      <td><% out.println(name.getMobile());%></td>
                      <td><% out.println(name.getUsername());%></td>
                      <td>
                        <a href="#"><span class="label label-danger" onclick="return alert('You can not delete Default User')" data-toggle="tooltip" data-placement="top" title="Click to Delete">Delete</span></a>
                        |<a href="#"><span class="label label-danger"  data-toggle="tooltip" data-placement="top" title="Click to Edit">Edit</span></a>
                      </td>
                    </tr>
                   <% } %>       
                  </table>
