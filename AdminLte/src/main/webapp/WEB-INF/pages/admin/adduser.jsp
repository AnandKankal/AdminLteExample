              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="add" method="post"> 
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="courses"   placeholder="Java" type="text" name="courses">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="password"   placehoder = "password"  type="password" name="password">
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="reset" id="reset" class="btn btn-danger pull-right" style="margin-left:5px;width:150px;">Reset</button>             
                  </div><!-- /.box-footer -->
                </form>
              </div><!-- /.box -->
