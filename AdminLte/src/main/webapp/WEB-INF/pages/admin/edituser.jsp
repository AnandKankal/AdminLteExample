  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" modelAttribute="user" method="post" action="<%=request.getContextPath() %>/updateUser" >
                
                	 <input class="form-control" required id="userid" name="userid" value="<%=user.getUserid() %>"  type="hidden">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">Username</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="username" name="username" value="<%=user.getUsername() %>" placeholder="Username" type="text">
                      </div>
                    </div>                    
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Mobile</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="mobile" value="<%=user.getMobile() %>" name="mobile" placeholder="Mobile" type="number">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Email</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="email" value="<%=user.getEmail() %>" name="email" placeholder="Email" type="email">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="course" value="<%=user.getCourses() %>" name="courses" placeholder="Java/J2EE" type="text">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:6px;">
                        ...
                        <input name="gender"  required id="Male" value="Male" <%=("Male".equals(user.getGender()) ? "checked":"")%> type="radio" style="margin-right:2px;"> Male
                        <input name="gender" required id="Female" value="Female" <%=("Female".equals(user.getGender()) ? "checked":"")%> type="radio" style="margin-right:2px;margin-left:10px;"> Female
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select required  name="state" class="form-control">
                          ...
                          <option value="Maharashtra" <%=("Maharashtra".equals(user.getState()) ? "selected":"")%>>Maharashtra</option>
                          <option value="Delhi" <%=("Delhi".equals(user.getState()) ? "selected":"")%> >Delhi</option>
                          <option value="HP" <%=("HP".equals(user.getState()) ? "selected":"")%> >HP</option>
                          <option value="Punjab" <%=("Punjab".equals(user.getState()) ? "selected":"")%>>Punjab</option>                          
                        </select>
                      </div>
                    </div>                    
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="password" name="password" value="<%=user.getPassword() %>" placeholder="Password" type="password">
                      </div>
                    </div>
                  
                  </div><!-- /.box-body -->
                  <div class="box-footer">
                    <button type="submit" id="submit" class="btn btn-info pull-center" style="margin-left:5px;width:150px;">Update</button>
                    <!--  <a href="#"><span class="btn btn-default pull-right" style="width:150px;">Cancel</span></a>-->                   
                  </div><!-- /.box-footer -->
                </form>
              </div><!-- /.box -->
      ...
      <footer class="main-footer">
        ...
        </script>  <a href="http://jbk.com">JBK</a>.</strong> All rights reserved.
      </footer>
