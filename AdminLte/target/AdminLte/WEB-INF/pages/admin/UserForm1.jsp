...
<%@ page import="com.javabykiran.model.State" %>
...
<html>
  <head>
    ...
    <title>AdminLTE |Add/Edit User</title>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Add/Edit User Form</h3>
                </div><!-- /.box-header -->
                <!-- form start --> 
                <form:form class="form-horizontal" action="saveEmployee" method="post" modelAttribute="User">
                <form:hidden path="userid"/>
                  <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Courses</label>
                      <div class="col-sm-4">
                        
                        <form:input class="form-control"  path="courses" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputGender3" class="col-sm-3 control-label">Gender</label>
                    ...
                    <div class="form-group">
                      <label for="inputGender3" class="col-sm-3 control-label">Is Default</label>
                      <div class="col-sm-4" style="margin-top:6px;">
                        <form:radiobutton   path="isDefault" value="Y"/>Y
                        <form:radiobutton   path="isDefault" value="N"/>N
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">       
						<form:select   class="form-control"    path="state">
                         ...
                         ArrayList<State> StatesList = (ArrayList<State>) request.getAttribute("StatesList");
                         for (State name:StatesList) {
                 			
                 			String option = name.getState();
                 			
                 			String Optionvalue = Integer.toString(name.getState_id());
                 			Integer o = name.getState_id();
                 			//String selected = (Optionvalue.equals(name.getState_id()) ? "selected":"");
                 			%>
                 			
                 			<c:choose>
							   <c:when test="<%=selectedStateId==o%>">
							       <form:option selected="true"  value="<%=Optionvalue %>" ><%=option%> </form:option>
							        <br />
							    </c:when>    
							    <c:otherwise>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="showUserList"><span class="btn btn-default pull-right" style="width:150px;">Cancel</span></a>             
                  </div><!-- /.box-footer -->
                </form:form>
              </div><!-- /.box -->
