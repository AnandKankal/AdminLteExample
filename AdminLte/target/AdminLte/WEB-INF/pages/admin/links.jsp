...
<html>
 ...
 <meta charset="utf-8">
    ...
    <title>AdminLTE 2 | Useful Links</title>
        ...
        <section class="sidebar">
          ...
          <!-- sidebar menu: : style can be found in sidebar.less -->
           <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="showUserList"><i class="fa fa-user"></i> <span>Users</span></a></li>
            <li><a href="operators"><i class="fa fa-retweet"></i> <span>Operators</span></a></li>
            <li class="active"><a href="links"><i class="fa fa-external-link"></i> <span>     Useful Links</span></a></li>
